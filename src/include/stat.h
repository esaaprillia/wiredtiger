...
struct __wt_connection_stats {
    ...
    int64_t layered_drain_ingest_usec_move_updates;
    int64_t layered_drain_ingest_usec_cursor_next;
    int64_t layered_drain_ingest_usec_prepare_work;
    int64_t layered_drain_ingest_usec_total;
