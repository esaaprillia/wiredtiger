...
struct __wt_connection_stats {
    ...
    int64_t page_cache_average_op_time;
    int64_t page_cache_hash_size;
    int64_t page_cache_hit;
    int64_t page_cache_max_bucket_size;
    int64_t page_cache_max_get_time;
    int64_t page_cache_max_page_ref_count;
    int64_t page_cache_max_put_time;
    int64_t page_cache_max_release_time;
    int64_t page_cache_memory_allocated;
    int64_t page_cache_miss;
    int64_t page_cache_total_entry_count;
    int64_t page_cache_total_op;
    int64_t page_cache_total_op_time;
    int64_t page_cache_total_page_count;
