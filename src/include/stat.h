...
struct __wt_connection_stats {
    ...
    int64_t cache_eviction_in_place_scrub_attempts;
    int64_t cache_eviction_in_place_scrub_blocked_instantiated;
    int64_t cache_eviction_in_place_scrub_blocked_not_checkpoint_reconciled;
    int64_t cache_eviction_in_place_scrub_blocked_multiblock;
    int64_t cache_eviction_in_place_scrub_blocked_no_dsk;
    int64_t cache_eviction_in_place_scrub_blocked_stale_dsk;
    int64_t cache_eviction_in_place_scrub_checkpoint_leaf_single_block;
    int64_t cache_eviction_in_place_scrub_checkpoint_leaf_multiblock;
    int64_t cache_eviction_in_place_scrub_eviction_leaf_single_block;
    int64_t cache_eviction_in_place_scrub_fallback_evicted_to_disk;
    int64_t cache_eviction_in_place_scrub_success;
    int64_t cache_eviction_in_place_scrub_saved_image_freed_by_recon;
    int64_t cache_eviction_in_place_scrub_saved_image_freed_by_discard;
    int64_t cache_eviction_in_place_scrub_skip_btree_in_memory;
    int64_t cache_eviction_in_place_scrub_skip_btree_readonly;
    int64_t cache_eviction_in_place_scrub_skip_closing;
    int64_t cache_eviction_in_place_scrub_skip_disagg_follower;
    int64_t cache_eviction_in_place_scrub_skip_disagg_meta;
    int64_t cache_eviction_in_place_scrub_skip_no_scrub_pass;
    int64_t cache_eviction_in_place_scrub_skip_history_store;
    int64_t cache_eviction_in_place_scrub_skip_conn_in_memory;
    int64_t cache_eviction_in_place_scrub_skip_metadata;
    int64_t cache_eviction_in_place_scrub_skip_no_modify;
    int64_t cache_eviction_in_place_scrub_skip_not_leaf;
    int64_t cache_eviction_in_place_scrub_skip_not_disagg_without_updates_eviction;
    int64_t cache_eviction_in_place_scrub_skip_checkpoint_sync;
    int64_t cache_eviction_in_place_scrub_skip_no_update_bytes;
