...
struct __wt_connection_stats {
    ...
    int64_t layered_drain_ingest_version_rows;
    int64_t layered_drain_ingest_keys_flushed;
    int64_t layered_drain_ingest_msec_move_updates;
    int64_t layered_drain_ingest_msec_cursor_next;
    int64_t layered_drain_ingest_msec_prepare_work;
    int64_t layered_drain_ingest_msec_truncate;
    int64_t layered_drain_ingest_msec_lookahead;
    int64_t layered_drain_ingest_msec_total;
    int64_t layered_drain_ingest_prefetch_active;
    int64_t layered_drain_ingest_updates_chained;
