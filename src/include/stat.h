...
struct __wt_connection_stats {
    ...
    int64_t rec_multiblock_unrealized_split_re_reconcile_checkpoint;
    int64_t rec_multiblock_unrealized_split_re_reconcile_eviction;
    int64_t rec_multiblock_checkpoint_evict_rejected;
    int64_t rec_multiblock_checkpoint_evict_review_page_dirty;
    int64_t rec_multiblock_checkpoint_evict_fail_last_error;
