...
#define WT_CONF_ID_Block_cache 198ULL
#define WT_CONF_ID_Checkpoint 213ULL
#define WT_CONF_ID_Checkpoint_cleanup 216ULL
#define WT_CONF_ID_Chunk_cache 219ULL
#define WT_CONF_ID_Compatibility 221ULL
#define WT_CONF_ID_Crash_point 225ULL
#define WT_CONF_ID_Debug 131ULL
#define WT_CONF_ID_Debug_mode 223ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 133ULL
#define WT_CONF_ID_Encryption 23ULL
#define WT_CONF_ID_Eviction 250ULL
#define WT_CONF_ID_File_manager 269ULL
#define WT_CONF_ID_Flush_tier 185ULL
#define WT_CONF_ID_Hash 337ULL
#define WT_CONF_ID_Heuristic_controls 274ULL
#define WT_CONF_ID_History_store 278ULL
#define WT_CONF_ID_Import 101ULL
#define WT_CONF_ID_Incremental 141ULL
...
#define WT_CONF_ID_Prefetch1 319ULL
...
#define WT_CONF_ID_available 349ULL
#define WT_CONF_ID_background 94ULL
#define WT_CONF_ID_background_compact 224ULL
#define WT_CONF_ID_backup 190ULL
#define WT_CONF_ID_backup_restore_target 320ULL
#define WT_CONF_ID_before_insert_colgroup 226ULL
#define WT_CONF_ID_before_insert_file 227ULL
#define WT_CONF_ID_bitmap 66ULL
#define WT_CONF_ID_blkcache_eviction_aggression 201ULL
...
#define WT_CONF_ID_buckets 338ULL
#define WT_CONF_ID_buffer_alignment 321ULL
#define WT_CONF_ID_builtin_extension_config 322ULL
#define WT_CONF_ID_bulk 129ULL
#define WT_CONF_ID_cache 191ULL
#define WT_CONF_ID_cache_cursors 313ULL
#define WT_CONF_ID_cache_directory 56ULL
#define WT_CONF_ID_cache_max_wait_ms 209ULL
#define WT_CONF_ID_cache_on_checkpoint 199ULL
#define WT_CONF_ID_cache_on_writes 200ULL
#define WT_CONF_ID_cache_overhead 210ULL
#define WT_CONF_ID_cache_resident 17ULL
#define WT_CONF_ID_cache_size 211ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 212ULL
#define WT_CONF_ID_cache_tolerance_for_app_eviction 257ULL
#define WT_CONF_ID_capacity 324ULL
...
#define WT_CONF_ID_checkpoint_retention 231ULL
#define WT_CONF_ID_checkpoint_sync 323ULL
...
#define WT_CONF_ID_compile_configuration_count 330ULL
#define WT_CONF_ID_compressor 342ULL
#define WT_CONF_ID_config 309ULL
#define WT_CONF_ID_config_base 331ULL
#define WT_CONF_ID_configuration 232ULL
#define WT_CONF_ID_consolidate 142ULL
#define WT_CONF_ID_corruption_abort 230ULL
#define WT_CONF_ID_create 332ULL
#define WT_CONF_ID_cross_key 138ULL
#define WT_CONF_ID_cursor_copy 233ULL
#define WT_CONF_ID_cursor_reposition 234ULL
#define WT_CONF_ID_cursors 192ULL
#define WT_CONF_ID_default 350ULL
#define WT_CONF_ID_delta_pct 293ULL
#define WT_CONF_ID_dhandle_buckets 339ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 333ULL
#define WT_CONF_ID_disagg_address_cookie_optional_field 236ULL
#define WT_CONF_ID_disagg_address_cookie_upgrade 235ULL
#define WT_CONF_ID_do_not_clear_txn_id 157ULL
#define WT_CONF_ID_drain_threads 76ULL
#define WT_CONF_ID_drop 184ULL
#define WT_CONF_ID_dryrun 95ULL
#define WT_CONF_ID_dump 140ULL
#define WT_CONF_ID_dump_address 158ULL
#define WT_CONF_ID_dump_all_data 159ULL
#define WT_CONF_ID_dump_blocks 160ULL
#define WT_CONF_ID_dump_key_data 161ULL
#define WT_CONF_ID_dump_layout 162ULL
#define WT_CONF_ID_dump_offsets 163ULL
#define WT_CONF_ID_dump_pages 164ULL
#define WT_CONF_ID_dump_tree_shape 165ULL
...
#define WT_CONF_ID_error_prefix 249ULL
#define WT_CONF_ID_evict_sample_inmem 253ULL
#define WT_CONF_ID_evict_use_softptr 254ULL
#define WT_CONF_ID_eviction 237ULL
#define WT_CONF_ID_eviction_checkpoint_target 261ULL
#define WT_CONF_ID_eviction_checkpoint_ts_ordering 248ULL
...
#define WT_CONF_ID_extensions 335ULL
#define WT_CONF_ID_extra_diagnostics 268ULL
#define WT_CONF_ID_extractor 71ULL
#define WT_CONF_ID_file 143ULL
#define WT_CONF_ID_file_extend 336ULL
#define WT_CONF_ID_file_max 279ULL
#define WT_CONF_ID_file_metadata 103ULL
#define WT_CONF_ID_file_wait_ms 218ULL
#define WT_CONF_ID_final_flush 188ULL
#define WT_CONF_ID_flush_time 73ULL
#define WT_CONF_ID_flush_timestamp 74ULL
#define WT_CONF_ID_flushed_data_cache_insertion 327ULL
#define WT_CONF_ID_force 124ULL
#define WT_CONF_ID_force_stop 144ULL
#define WT_CONF_ID_force_write_wait 343ULL
#define WT_CONF_ID_format 26ULL
#define WT_CONF_ID_free_space_target 97ULL
#define WT_CONF_ID_full_target 202ULL
#define WT_CONF_ID_generation_drain_timeout_ms 273ULL
#define WT_CONF_ID_get 156ULL
#define WT_CONF_ID_granularity 145ULL
#define WT_CONF_ID_handles 193ULL
#define WT_CONF_ID_hashsize 204ULL
#define WT_CONF_ID_hazard_max 340ULL
...
#define WT_CONF_ID_interval 356ULL
#define WT_CONF_ID_isolation 171ULL
...
#define WT_CONF_ID_leak_memory 189ULL
#define WT_CONF_ID_legacy_page_visit_strategy 255ULL
#define WT_CONF_ID_local_files_action 78ULL
#define WT_CONF_ID_local_retention 57ULL
#define WT_CONF_ID_lock_wait 125ULL
#define WT_CONF_ID_log 194ULL
#define WT_CONF_ID_log_retention 238ULL
#define WT_CONF_ID_log_size 214ULL
#define WT_CONF_ID_lose_all_my_data 79ULL
#define WT_CONF_ID_max_consecutive_delta 296ULL
#define WT_CONF_ID_max_percent_overhead 205ULL
...
#define WT_CONF_ID_metadata 195ULL
#define WT_CONF_ID_metadata_file 104ULL
#define WT_CONF_ID_method 217ULL
#define WT_CONF_ID_mmap 345ULL
#define WT_CONF_ID_mmap_all 346ULL
#define WT_CONF_ID_multiprocess 347ULL
#define WT_CONF_ID_name 24ULL
#define WT_CONF_ID_nbits 67ULL
#define WT_CONF_ID_next_random 148ULL
#define WT_CONF_ID_next_random_sample_size 149ULL
#define WT_CONF_ID_next_random_seed 150ULL
#define WT_CONF_ID_no_timestamp 172ULL
#define WT_CONF_ID_nvram_path 206ULL
...
#define WT_CONF_ID_page_history 239ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_panic_corrupt 105ULL
#define WT_CONF_ID_path 291ULL
#define WT_CONF_ID_percent_file_in_dram 207ULL
#define WT_CONF_ID_pinned 220ULL
#define WT_CONF_ID_prealloc 286ULL
#define WT_CONF_ID_prealloc_init_count 287ULL
#define WT_CONF_ID_precise_checkpoint 348ULL
#define WT_CONF_ID_prefer_scrub_eviction 259ULL
...
#define WT_CONF_ID_prepare_timestamp 178ULL
#define WT_CONF_ID_prepared 176ULL
#define WT_CONF_ID_prepared_id 179ULL
#define WT_CONF_ID_preserve_prepared 351ULL
#define WT_CONF_ID_priority 174ULL
#define WT_CONF_ID_quota 301ULL
#define WT_CONF_ID_raw 151ULL
#define WT_CONF_ID_raw_key_value 137ULL
#define WT_CONF_ID_read 177ULL
#define WT_CONF_ID_read_corrupt 166ULL
#define WT_CONF_ID_read_once 152ULL
#define WT_CONF_ID_read_size 341ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 68ULL
#define WT_CONF_ID_realloc_exact 240ULL
#define WT_CONF_ID_realloc_malloc 241ULL
#define WT_CONF_ID_recover 344ULL
#define WT_CONF_ID_release 222ULL
#define WT_CONF_ID_release_evict 139ULL
...
#define WT_CONF_ID_require_max 328ULL
#define WT_CONF_ID_require_min 329ULL
#define WT_CONF_ID_reserve 302ULL
#define WT_CONF_ID_role 80ULL
#define WT_CONF_ID_rollback_error 242ULL
#define WT_CONF_ID_rollback_timestamp 180ULL
#define WT_CONF_ID_run_once 98ULL
#define WT_CONF_ID_salvage 352ULL
#define WT_CONF_ID_secretkey 334ULL
#define WT_CONF_ID_session_max 353ULL
#define WT_CONF_ID_session_scratch_max 354ULL
#define WT_CONF_ID_session_table_cache 355ULL
#define WT_CONF_ID_sessions 196ULL
#define WT_CONF_ID_shared 59ULL
#define WT_CONF_ID_size 203ULL
#define WT_CONF_ID_skip_checkpoint 187ULL
#define WT_CONF_ID_skip_sort_check 153ULL
#define WT_CONF_ID_skip_update_obsolete_check 260ULL
#define WT_CONF_ID_slow_checkpoint 243ULL
...
#define WT_CONF_ID_src_id 146ULL
...
#define WT_CONF_ID_statistics 154ULL
#define WT_CONF_ID_storage_path 326ULL
#define WT_CONF_ID_storage_tier 22ULL
#define WT_CONF_ID_stress_skiplist 244ULL
#define WT_CONF_ID_strict 168ULL
#define WT_CONF_ID_suffix 120ULL
#define WT_CONF_ID_sync 128ULL
#define WT_CONF_ID_system_ram 208ULL
#define WT_CONF_ID_table_logging 245ULL
#define WT_CONF_ID_target 155ULL
#define WT_CONF_ID_terminate 312ULL
#define WT_CONF_ID_this_id 147ULL
#define WT_CONF_ID_threads 298ULL
#define WT_CONF_ID_threads_max 251ULL
#define WT_CONF_ID_threads_min 252ULL
#define WT_CONF_ID_tiered_flush_error_continue 246ULL
...
#define WT_CONF_ID_txn 197ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 247ULL
#define WT_CONF_ID_use_environment 358ULL
#define WT_CONF_ID_use_environment_priv 359ULL
#define WT_CONF_ID_use_timestamp 186ULL
#define WT_CONF_ID_value_format 60ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 360ULL
#define WT_CONF_ID_version 70ULL
#define WT_CONF_ID_visible_only 134ULL
#define WT_CONF_ID_wait 215ULL
#define WT_CONF_ID_write_through 361ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 289ULL

#define WT_CONF_ID_COUNT 362
/*
