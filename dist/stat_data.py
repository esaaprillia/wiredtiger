...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_in_place_scrub_attempts', 'in-place scrub: attempts to replace a clean leaf page from its disk image'),
    CacheStat('cache_eviction_in_place_scrub_blocked_instantiated', 'in-place scrub: blocked because page was instantiated from a fast-truncate'),
    CacheStat('cache_eviction_in_place_scrub_blocked_multiblock', 'in-place scrub: blocked because page was reconciled into multiple blocks (no single image)'),
    CacheStat('cache_eviction_in_place_scrub_blocked_no_dsk', 'in-place scrub: blocked, page has no on-disk image (never written to disk)'),
    CacheStat('cache_eviction_in_place_scrub_blocked_not_checkpoint_reconciled', 'in-place scrub: blocked because page was not reconciled by checkpoint (rec_result == 0)'),
    CacheStat('cache_eviction_in_place_scrub_blocked_stale_dsk', 'in-place scrub: blocked, saved checkpoint image is NULL and page dsk is stale (ref->addr freed)'),
    CacheStat('cache_eviction_in_place_scrub_checkpoint_leaf_multiblock', 'in-place scrub: checkpoint reconciled a leaf page into multiple blocks'),
    CacheStat('cache_eviction_in_place_scrub_checkpoint_leaf_single_block', 'in-place scrub: checkpoint reconciled a leaf page into a single block (image saved)'),
    CacheStat('cache_eviction_in_place_scrub_eviction_leaf_single_block', 'in-place scrub: eviction (non-checkpoint) reconciled a leaf page into a single block'),
    CacheStat('cache_eviction_in_place_scrub_fallback_evicted_to_disk', 'in-place scrub: fallback, clean page with updates evicted to disk instead'),
    CacheStat('cache_eviction_in_place_scrub_saved_image_freed_by_discard', 'in-place scrub: saved checkpoint image freed during page discard (not reconciliation)'),
    CacheStat('cache_eviction_in_place_scrub_saved_image_freed_by_recon', 'in-place scrub: saved checkpoint image discarded by a subsequent reconciliation'),
    CacheStat('cache_eviction_in_place_scrub_skip_btree_in_memory', 'in-place scrub: skipped clean+updates candidate; btree is in-memory'),
    CacheStat('cache_eviction_in_place_scrub_skip_btree_readonly', 'in-place scrub: skipped clean+updates candidate; btree is read-only'),
    CacheStat('cache_eviction_in_place_scrub_skip_checkpoint_sync', 'in-place scrub: skipped clean+updates candidate; session syncing btree'),
    CacheStat('cache_eviction_in_place_scrub_skip_closing', 'in-place scrub: skipped clean+updates candidate; closing eviction'),
    CacheStat('cache_eviction_in_place_scrub_skip_conn_in_memory', 'in-place scrub: skipped clean+updates candidate; in-memory connection'),
    CacheStat('cache_eviction_in_place_scrub_skip_disagg_follower', 'in-place scrub: skipped clean+updates candidate; disaggregated follower'),
    CacheStat('cache_eviction_in_place_scrub_skip_disagg_meta', 'in-place scrub: skipped clean+updates candidate; disaggregated metadata'),
    CacheStat('cache_eviction_in_place_scrub_skip_history_store', 'in-place scrub: skipped clean+updates candidate; history store'),
    CacheStat('cache_eviction_in_place_scrub_skip_metadata', 'in-place scrub: skipped clean+updates candidate; metadata'),
    CacheStat('cache_eviction_in_place_scrub_skip_no_modify', 'in-place scrub: skipped clean+updates candidate; no page modify struct'),
    CacheStat('cache_eviction_in_place_scrub_skip_no_scrub_pass', 'in-place scrub: skipped clean+updates candidate; eviction pass has no scrub flag'),
    CacheStat('cache_eviction_in_place_scrub_skip_no_update_bytes', 'in-place scrub: skipped clean+updates candidate; zero bytes_updates'),
    CacheStat('cache_eviction_in_place_scrub_skip_not_disagg_without_updates_eviction', 'in-place scrub: skipped clean+updates candidate; not disagg and updates eviction not active'),
    CacheStat('cache_eviction_in_place_scrub_skip_not_leaf', 'in-place scrub: skipped clean+updates candidate; not a leaf page'),
    CacheStat('cache_eviction_in_place_scrub_success', 'in-place scrub: happy path, page successfully replaced from disk image'),
