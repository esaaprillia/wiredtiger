...
conn_stats = [
    ...
    CacheStat('page_cache_average_op_time', 'page_cache_average_op_time', 'no_clear,no_scale'),
    CacheStat('page_cache_hash_size', 'page_cache_hash_size', 'no_clear,no_scale'),
    CacheStat('page_cache_hit', 'page_cache_hit', 'no_clear,no_scale'),
    CacheStat('page_cache_max_bucket_size', 'page_cache_max_bucket_size', 'no_clear,no_scale'),
    CacheStat('page_cache_max_get_time', 'page_cache_max_get_time', 'no_clear,no_scale'),
    CacheStat('page_cache_max_page_ref_count', 'page_cache_max_page_ref_count', 'no_clear,no_scale'),
    CacheStat('page_cache_max_put_time', 'page_cache_max_put_time', 'no_clear'),
    CacheStat('page_cache_max_release_time', 'page_cache_max_release_time', 'no_clear,no_scale'),
    CacheStat('page_cache_memory_allocated', 'page_cache_memory_allocated', 'no_clear,no_scale'),
    CacheStat('page_cache_miss', 'page_cache_miss', 'no_clear,no_scale'),
    CacheStat('page_cache_total_entry_count', 'page_cache_total_entry_count', 'no_clear,no_scale'),
    CacheStat('page_cache_total_op', 'page_cache_total_op', 'no_clear,no_scale'),
    CacheStat('page_cache_total_op_time', 'page_cache_total_op_time', 'no_clear,no_scale'),
    CacheStat('page_cache_total_page_count', 'page_cache_total_page_count', 'no_clear,no_scale'),
