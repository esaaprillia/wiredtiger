...
conn_dsrc_stats = [
    ...
    RecStat('rec_multiblock_checkpoint_evict_fail_last_error', 'leaf pages with a multi block reconciliation, last error code from a failed eviction attempt'),
    RecStat('rec_multiblock_checkpoint_evict_page_cant_evict_checkpoint', 'leaf pages with a multi block reconciliation rejected at review, page cannot be evicted due to checkpoint running'),
    RecStat('rec_multiblock_checkpoint_evict_page_cant_evict_materialization', 'leaf pages with a multi block reconciliation rejected at review, page cannot be evicted due to materialization frontier'),
    RecStat('rec_multiblock_checkpoint_evict_page_cant_evict_materialization_clean', 'leaf pages with a multi block reconciliation rejected at review, page cannot be evicted due to materialization frontier, clean page'),
    RecStat('rec_multiblock_checkpoint_evict_page_cant_evict_next_checkpoint', 'leaf pages with a multi block reconciliation rejected at review, page cannot be evicted due to belonging to the next checkpoint'),
    RecStat('rec_multiblock_checkpoint_evict_rejected', 'leaf pages with a multi block reconciliation that were rejected by eviction after checkpoint queued them'),
    RecStat('rec_multiblock_checkpoint_evict_rejected_exclusive', 'leaf pages with a multi block reconciliation rejected by eviction, exclusive access failed'),
    RecStat('rec_multiblock_checkpoint_evict_rejected_review', 'leaf pages with a multi block reconciliation rejected by eviction, review failed'),
    RecStat('rec_multiblock_checkpoint_evict_rejected_update', 'leaf pages with a multi block reconciliation rejected by eviction, page update failed'),
    RecStat('rec_multiblock_checkpoint_evict_review_blocked_syncing', 'leaf pages with a multi block reconciliation rejected at review, dirty and btree syncing'),
    RecStat('rec_multiblock_checkpoint_evict_review_cannot_evict', 'leaf pages with a multi block reconciliation rejected at review, page cannot be evicted'),
    RecStat('rec_multiblock_checkpoint_evict_review_hs_dirty', 'leaf pages with a multi block reconciliation rejected at review, history store dirty'),
    RecStat('rec_multiblock_checkpoint_evict_review_inmemory', 'leaf pages with a multi block reconciliation rejected at review, in-memory btree'),
    RecStat('rec_multiblock_checkpoint_evict_review_no_reconcile', 'leaf pages with a multi block reconciliation rejected at review, reconciliation disabled'),
    RecStat('rec_multiblock_checkpoint_evict_review_page_dirty', 'leaf pages with a multi block reconciliation where the page was dirty at eviction time'),
    RecStat('rec_multiblock_checkpoint_evict_review_precise_ckpt', 'leaf pages with a multi block reconciliation rejected at review, precise checkpoint'),
    RecStat('rec_multiblock_checkpoint_evict_review_reconcile_fail', 'leaf pages with a multi block reconciliation rejected by eviction, reconciliation failed'),
    RecStat('rec_multiblock_checkpoint_evict_success', 'leaf pages with a multi block reconciliation successfully evicted after checkpoint'),
    RecStat('rec_multiblock_checkpoint_flagged', 'leaf pages with a multi block reconciliation flagged for eviction during checkpoint'),
    RecStat('rec_multiblock_checkpoint_flagged_dirty', 'leaf pages with a multi block reconciliation flagged for eviction during checkpoint, dirty'),
    RecStat('rec_multiblock_checkpoint_queued_evict', 'leaf pages with a multi block reconciliation that was queued for urgent eviction during walk'),
    RecStat('rec_multiblock_checkpoint_queued_evict_fail', 'leaf pages with a multi block reconciliation that was queued for urgent eviction during walk, fail'),
    RecStat('rec_multiblock_internal', 'internal page multi-block writes'),
    RecStat('rec_multiblock_leaf', 'leaf page multi-block writes'),
    RecStat('rec_multiblock_unrealized_split_re_reconcile_checkpoint', 'leaf pages with a multi block reconciliation that were re-reconciled by checkpoint'),
    RecStat('rec_multiblock_unrealized_split_re_reconcile_eviction', 'leaf pages with a multi block reconciliation that were re-reconciled by eviction'),
    RecStat('rec_multiblock_unrealized_split_re_reconcile_total', 'leaf pages with a multi block reconciliation that were re-reconciled by any method'),
