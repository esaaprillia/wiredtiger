...
conn_dsrc_stats = [
    ...
    RecStat('rec_multiblock_checkpoint_queued_evict', 'leaf pages with a multi block reconciliation that was queued for urgent eviction during checkpoint'),
    RecStat('rec_multiblock_checkpoint_queued_evict_fail', 'leaf pages with a multi block reconciliation that was queued for urgent eviction during checkpoint, fail'),
