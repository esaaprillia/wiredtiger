...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_dirty_index_hit', 'dirty index entries queued to eviction queue'),
    CacheStat('cache_eviction_dirty_index_insert', 'dirty index inserts from modify path'),
    CacheStat('cache_eviction_dirty_index_insert_contended', 'dirty index inserts dropped due to producer lock contention'),
    CacheStat('cache_eviction_dirty_index_overwrite', 'dirty index entries overwritten because producers lapped consumers'),
    CacheStat('cache_eviction_dirty_index_scanned', 'dirty index slots examined by the drain path'),
    CacheStat('cache_eviction_dirty_index_skip_active_txn', 'dirty index slots skipped because the page has a running transaction update'),
    CacheStat('cache_eviction_dirty_index_stale', 'dirty index slots skipped because the ref was not in memory'),
